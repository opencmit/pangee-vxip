...
const (
	...
	MapConnKeySz        int           = 40
	MapConnValSz        int           = 56
	TickerTimeSec       time.Duration = 2 * time.Second
	...
	srvMinIdxOffset     int           = 36
	srvMaxIdxOffset     int           = 38
...
func (v *SrvVal) Marshal() ([]byte, error) {
	...
	PutUint16(b[srvMinIdxOffset:], v.MinPort)
	PutUint16(b[srvMaxIdxOffset:], v.MaxPort)
	return b, nil
}
